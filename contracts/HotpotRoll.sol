...
// HotpotRoll helps your migrate your existing Uniswap LP tokens to HotpotSwap LP ones
contract HotpotRoll {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'HotpotSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'HotpotRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'HotpotRoll: INSUFFICIENT_B_AMOUNT');
    }
