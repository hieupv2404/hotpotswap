...
module.exports = async function ({ getNamedAccounts, getChainId, deployments }) {
  ...
  const hotpotswapRouterAddress = (await deployments.get("UniswapV2Router02")).address

  await deploy("HotpotRoll", {
    from: deployer,
    args: [uniswapRouterAddress, hotpotswapRouterAddress],
    log: true,
    deterministicDeployment: false
  })
}

module.exports.tags = ["HotpotRoll"]
