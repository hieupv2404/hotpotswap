...
# Adding virtual to hotpotPerBlock()
perl -0777 -i -pe 's/function hotpotPerBlock\(\) public view returns/function hotpotPerBlock\(\) public view virtual returns/g' contracts/MasterChefV2.sol
